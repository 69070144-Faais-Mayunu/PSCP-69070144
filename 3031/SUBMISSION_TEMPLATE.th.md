...
```text
ต้องรับค่าจากหลายๆบ้านเเล้วคำนวนว่าจะไปถึงตำเเหน่งนั้นๆตอนไหน
```
...
```text
Step 1:รับค่าความเร็วในการขยายของหมึกเเละจำนวนคนที่ต้องรับ
Step 2:ใช้loopรับตำเเหน่งบ้านเเต่ละบ้าน
Step 3:ใช้สูตรหาว่าจะไปถึงตำเเหน่งนั้นตอนไหน
```
