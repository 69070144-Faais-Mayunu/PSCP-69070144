...
```text
โจทย์นี้ต้องการจะรู้ว่าถ้าต้องไปห้องที่1ต้องผ่านกำเเพงกี่ชั้น

Input:
รับค่าห้องที่อยู่

Output:
จำนวนกำเเพงที่ต้องผ่าน

Constraints:
กำเเพงที่ใช้ผ่านไปชั้นต่อไปบางครั้งใช้เเค่1หรือใช้เเค่2ต้องหาสูตรดีๆ
```
...
```text
Step 1:รับค่าห้องที่อยู่
Step 2:นำไปคำนวนหาจำนวนกำเเพงที่ต้องผ่าน
Step 3:ใเเสดงจำนวนกำเเพงที่ต้องผ่าน
```
...
```text
บอกสูตรกำเเพงที่ต้องผ่านในห้องเเรกที่เริ่ม
```
