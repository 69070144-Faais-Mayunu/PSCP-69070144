...
```text
โจทย์ให้inputตัวเลขเข้าไปเเล้วอยากไห้printทุกตัวที่หาร10ออกมาไห้เห็น

Input:
โปรแกรมinputตัวเลขเข้าไป

Output:
โปรแกรมควรเเสดงทุกตัวที่หาร10ออกมาไห้เห็น

Constraints:
ไห้หารเเบบไม่เอาเศษก่อนเเล้วคูณ10เพื่่อไห้หาร10ลงตัว
```
...
```text
Step 1:รับค่าinputเลขเข้า
Step 2:นำไปหาร10ไม่เอาเศษเเล้วคูณ10ลับมาไห้เท่าเดิม
Step 3:ใช้loopไห้printเเละ-10เรื่อยๆจนกว่าจะถึง0
```
...
```text
เหมือนกันเเพราะโจทย์ต้องการเเค่นั้น
```
