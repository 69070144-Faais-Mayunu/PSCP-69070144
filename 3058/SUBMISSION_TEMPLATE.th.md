...
```text
โจทย์แยากรู้ว่าต้องใช้อิฐยาวมากสุดเท่าไหร่เเละเหลืออิฐเล็กเท่าไหราเเล้วสร้างเส็จหรือไม่

Input:
รับค่าอิฐเล็กอิฐใหญ่

Output:
เเสดงเหลืออิฐเล็กเท่าไหร่หรือถ้าไม่ถึงไห้เเสดง-1

Constraints:
ไม่มีอะไรเเค่ต้องหาสูตรคำนวนไห้ได้เฉยๆ
```
