...
```text
โจทย์อยากรู้ว่าในช่วงA-Bมีตัวที่หารด้วยdเเล้วเหลือเศษrกี่ตัว

Input:
รับค่าa,b,d,r

Output:
เเสดงจำนวนที่หารแล้วเหลือrว่ามีกี่ตัว

Constraints:
ไม่มีอะไรเเค่ทำตามที่โจทย์บอก
```
...
Step 2:ใช้ for loop ในช่วงa-bเชคตามเงื่อนใข
Step 3:เเสดงจำนวน
```
