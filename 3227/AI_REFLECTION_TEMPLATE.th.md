...
| Item | Answer |
|---|---|
| OJ problem number/title |[LEARNING LOGS] ไพ่ 44 ใบ|
| OJ submission ID, if submitted |648033|
| OJ status | Pass |
...
```text
ถามว่าจะลดการใช้ifยังไงดีเพรสะใช้ifไปเยอะมาก
```
...
```text
วิธีเเยกเลขกับตัวอักษรโดยใช้is digit เเละโค้ดอื่นๆ
```
