...
```text
โจทย์อยากไห้บอกชื่อเต็มจากค่าที่ใส่ไป

Input:
โปรแกรมรับข้อความหรือตัวเลขของไพ่สั้นๆเข้ามา

Output:
ชื่อเต็มๆของการ์ดนั้น

Constraints:
input ที่เข้ามานั้นมีได้ทั้งตัวเลขเเละตัวอักษรต้องเเยกดีๆ
```
...
```text
Step 1:รับค่าเข้ามา
Step 2:ใช้is digitเเยกตัวอักษรเเละเลขถ้ามี
Step 3:สร้าง Dic ไห้ตรงกับเงื่อนใขที่บอก
```
