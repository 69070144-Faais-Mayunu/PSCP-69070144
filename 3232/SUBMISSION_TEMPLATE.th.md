...
```text
โจทย์ให้inputตัวเลขเข้าไปเป็นทีละกี่ช่องเป้าหมายเท่าไรเเล้วทุกครั้งที่กระโดดจะกระโดดสั้นลง 2 เเละหาว่าถึงจุดหมายไหม

Input:
โปรแกรมinputตัวเลขเข้าไปเป็นระยะกระโดดเเละระยะจุดหมาย

Output:
โดดกี่รอบจนถึงจุดหมายหรือหาว่าถึงจุดหมายหรือไม่

Constraints:
ทุกครั้งที่กระโดดระยะโดดจะสั้นลง2ทุกครั้ง
```
...
```text
Step 1:รับค่าระยะกรโดดเเละระยะจุดหมาย
Step 2:ใช้while loop ให้โดดจนกว่าจะึงจุดหมายหรือระยะกรโดดน้อยกว่า0
Step 3:แสดงว่าถึงจุดหมายโดดไปกี่ครั้งหรือเเสดง-1ถ้าไม่ถึง
```
