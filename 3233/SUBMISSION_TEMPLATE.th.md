...
```text
โจทย์นี้เเค่รับค่ามาเเล้วเชคว่าตรงกันตามเงื่อนใขไหนเเล้วต้องเเสดงออกมาเป็นอะไรเเค่นั้น

Input:
รับค่าที่ซื้อเเละค่าที่ออก

Output:
เเสดงตามเงื่อนใขที่ตรง

Constraints:
ไม่มีอะไรเเค่เช็คว่าตรงเงื่อนไขไหนบ้างเเค่นั้น
```
