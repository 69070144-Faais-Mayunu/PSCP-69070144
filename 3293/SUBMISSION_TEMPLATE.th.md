...
```text
โจทย์นี้อยากไห้สร้างกรอบมาล้อมรอบคำที่ใส่เข้าไป

Input:
รับค่าตัวอักษร

Output:
เเสดงคำที่รับเข้ามาโดยที่มีกรอบล้อมรอบมาปิดพอดี

Constraints:
ต้องหาวิธีที่จะปิดกรอบไห้พอดี
```
...
```text
Step 1:รับค่าเข้าเเล้วหาว่าค่าตัวไหนยาวสุด
Step 2:สร้างเงื่อนสำหรับเเต่ละเเถว
Step 3:เเสดงค่าออกมา
```
