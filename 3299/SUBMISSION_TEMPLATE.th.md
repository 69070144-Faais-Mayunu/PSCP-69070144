...
```text
โจทย์การจะรู้ว่าถ้าปลูกต้นไม้เท่านี้จะต้องปลูกไปถึงเเถวไหน

Input:
รับค่าความกว้างเเถวเเละจำนวนต้นที่จะปลูก

Output:
เเสดงว่าต้นสุดท้ายที่ปลูกอยู่เเถวไหน

Constraints:
ต้องหาสูตรคำนวนไห้ได้
```
...
```text
Step 1:ค่าความกว้างเเถว
Step 2:นำไปคำนวน
Step 3:เเสดงตำเเหน่งเเถวที่อยู่
```
...
```text
บอกไห้หาสูตรเเละก็ช่วยเรื่องสูตร
```
